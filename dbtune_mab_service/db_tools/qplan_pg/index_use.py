...
#         if isinstance(*args, str):
#             key = args[0]
#             if key == constants.COST_TYPE_ELAPSED_TIME:
#                 return self.act_elapsed_max
#             elif key == constants.COST_TYPE_CPU_TIME:
#                 return self.act_cpu_max
#             elif key == constants.COST_TYPE_SUB_TREE_COST:
#                 return self.sub_tree_cost
...
#     def add_index(self, table, index, index_kind):
#         self.indices.append(Index(table, index, index_kind))


# class IndexRead(IndexUse):
#     def __init__(self, node_id, table, index, index_kind, act_elapsed_max, act_elapsed_sum, est_elapsed,
#                  act_cpu_max, act_cpu_sum, est_cpu, sub_tree_cost, act_rows_read, act_rows_output,
#                  est_rows_read, est_rows_output, table_cardinality):
#         super().__init__(node_id, act_elapsed_max, act_elapsed_sum, est_elapsed, act_cpu_max, act_cpu_sum,
#                          est_cpu, sub_tree_cost, act_rows_output, est_rows_output)
#         self.add_index(table, index, index_kind)
#         self.act_rows_read = act_rows_read
#         self.est_rows_read = est_rows_read
...
#     def __init__(self, node_id, table, index, index_kind, act_elapsed_max, act_elapsed_sum, est_elapsed,
#                  act_cpu_max, act_cpu_sum, est_cpu, sub_tree_cost, act_rows_read, act_rows_output,
#                  est_rows_read, est_rows_output, table_cardinality, view_tables):
#         super().__init__(node_id, table, index, index_kind, act_elapsed_max, act_elapsed_sum, est_elapsed,
#                          act_cpu_max, act_cpu_sum, est_cpu, sub_tree_cost, act_rows_read, act_rows_output,
#                          est_rows_read, est_rows_output, table_cardinality)
#         self.view_tables = view_tables


# class PgIndexRead(IndexRead):
#     def __init__(self, node_id, table, index, index_kind, act_elapsed_max, act_elapsed_sum, est_elapsed,
#                  act_cpu_max, act_cpu_sum, est_cpu, sub_tree_cost, act_rows_read, act_rows_output, est_rows_output,
#                  est_rows_read, table_cardinality):
#         super().__init__(node_id, table, index, index_kind, act_elapsed_max, act_elapsed_sum, est_elapsed,
#                          act_cpu_max, act_cpu_sum, est_cpu, sub_tree_cost, act_rows_read, act_rows_output,
#                          est_rows_read, est_rows_output, table_cardinality)


# class PgIndexWrite(IndexWrite):
#     def __init__(self, node_id, act_elapsed_max, act_elapsed_sum, est_elapsed, act_cpu_max, act_cpu_sum, est_cpu,
#                  sub_tree_cost, act_rows_output, est_rows_output):
#         super().__init__(node_id, act_elapsed_max, act_elapsed_sum, est_elapsed, act_cpu_max, act_cpu_sum,
#                          est_cpu, sub_tree_cost, act_rows_output, est_rows_output)
